    ...
    >
      <div className="mx-auto flex max-w-[83rem] flex-col gap-12 px-6 py-20">
        <Reveal className="max-w-3xl" sectionId="clientes">
          ...
          <p className="mt-4 text-left text-base font-bold text-slate-600">Experiencia multisectorial</p>
        </Reveal>
        ...
        >
          {clients.map((client) => (
            <StaggerItem key={client.name} className="h-full">
              <article
                className="
                  mx-auto flex h-full w-full max-w-[22rem] flex-col overflow-hidden rounded-2xl bg-white
