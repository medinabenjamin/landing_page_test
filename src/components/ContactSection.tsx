      ...
      <div className="mx-auto max-w-[83rem] px-6 py-20">
        <Reveal className="space-y-10" sectionId="contacto">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-[33px] font-bold leading-tight text-[#0B5C5B] md:text-[45px]">
                ...
                <div className="relative pl-12">
                  ...
                  <div className="space-y-5 text-white/90">
                    <div className="relative">
                      ...
                      <p className="text-left text-sm text-white/80">Analizamos tus necesidades y objetivos.</p>
                    </div>
                    ...
                    <div className="relative">
                      ...
                      <p className="text-left text-sm text-white/80">Agendamos una conversación para conocerte mejor.</p>
                    </div>
                    ...
                    <div className="relative">
                      ...
                      <p className="text-left text-sm text-white/80">Evaluamos tus desafíos y oportunidades actuales.</p>
                    </div>
                    ...
                    <div className="relative">
                      ...
                      <p className="text-left text-sm text-white/80">Recibes una propuesta detallada y accionable.</p>
                    </div>
                  </div>
                </div>
